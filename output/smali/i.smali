...
.method private j()V
    ...
    putfield i->a:Ljava/io/DataInputStream;
    aload_0
    ldc '/d'  # resource: unknown/binary/d
    invokestatic a->a(Ljava/lang/String;)Ljava/io/InputStream;
    invokestatic a->a(Ljava/io/InputStream;)Ljava/io/DataInputStream;
    putfield i->a:Ljava/io/DataInputStream;
    aload_0
    ...
    istore 0x4
    iload_1
    lookupswitch 0x24 [[0x8c, 0x19], [0x8d, 0x20]]
    bipush 0x20
    istore 0x4
    goto 0x7
    bipush 0x5f
...
.method public final run()V
    ...
    aload_0
    getfield i->i:B
    tableswitch 0x43 0x0 0x2 [[0x1c], [0x26], [0x3c]]
    aload_0
    getfield i->a:Lf;
    invokevirtual f->e()V
    goto 0x20
...
.method private a(I)B
    ...
    goto 0xb0
    iload_1
    tableswitch 0x68 0x30 0x39 [[0x3a], [0x3f], [0x55], [0x44], [0x60], [0x35], [0x65], [0x49], [0x5a], [0x4f]]
    iconst_5
    istore_2
    goto 0x31
    iconst_0
...
.method private n()V
    ...
    aconst_null
    astore_1
    ldc '/d0'  # resource: unknown/binary/d0
    invokestatic a->a(Ljava/lang/String;)Ljava/io/InputStream;
    invokestatic a->a(Ljava/io/InputStream;)Ljava/io/DataInputStream;
    astore_1
    aload_0
...
.method private o()V
    ...
    aconst_null
    astore_1
    ldc '/ml'  # resource: unknown/binary/ml
    invokestatic a->a(Ljava/lang/String;)Ljava/io/InputStream;
    invokestatic a->a(Ljava/io/InputStream;)Ljava/io/DataInputStream;
    dup
    astore_1
